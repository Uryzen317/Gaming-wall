...
export class GameSectionComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.sortedStyles = [
      `-left-20 sm:-left-36 scale-75 z-0 blur-sm cursor-default shadow-${this.game.primaryColor}`,
      `-left-10 sm:-left-16 scale-90 z-10 blur-[1px] cursor-default shadow-${this.game.primaryColor}`,
      `left-0 sm:left-0 scale-100 z-20 blur-none cursor-pointer shadow-${this.game.primaryColor}`,
      `-right-10 sm:-right-16 scale-90 z-10 blur-[1px] cursor-default shadow-${this.game.primaryColor}`,
      `-right-20 sm:-right-36 scale-75 z-0 blur-sm cursor-default shadow-${this.game.primaryColor}`
    ];
    this.styles = [
      this.sortedStyles[0],
      this.sortedStyles[1],
