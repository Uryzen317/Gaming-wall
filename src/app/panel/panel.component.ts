...
export class PanelComponent implements OnInit {
  constructor(public router: Router, public route: ActivatedRoute , public registrationService : RegistrationService) {}
  ...
  ngOnInit(): void {
    ...
    if(!isCached){
      ...
      this.registrationService.regState.subscribe({next : (value : any) => {
        if(value)
          {
